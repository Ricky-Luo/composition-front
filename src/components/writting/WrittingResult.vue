<template>
  <v-container fluid style="padding: 0px; width: 1500px; height: fit-content">
    <v-card elevation="0">
      <v-card-title> 任务与批改结果 </v-card-title>
      <v-card-text>
        <div
          style="
            width: 100%;
    ...
    <div style="width: 100%; display: flex; justify-content: center">
      <v-card
        style="margin-top: 12px; margin-bottom: 120px; width: 1500px"
        elevation="0"
      >
        <v-card-title> 评价与得分 <span style="margin-left:12px;color:red;">6.5分</span></v-card-title>
        <v-card-text style="color:rgba(0, 0, 0, 0.87);">
          <div style="display: flex">
            <div style="width: 50%">
              ...
              <article>
                The charts compared the average percentages of three types of
                nutrients in typical meals in the USA. It is easy to see that
                both sodium and saturated fat are consumed most in dinner in
                typical meals compared to the other three meals. The sodium
                intake in dinner is 43%, and the saturated fat is 37%. On the
                other hand, there is far less percentage of added sugar being
                consumed in dinner(23%), while people in USA take most of added
                sugar from snacks(42%). Breakfast generates very small
                proportions of unhealthy ingredients. There is 14% of sodium
                consumed in breakfast, which is equal to the figure for snacks.
                Additionally, the percentages of saturated fat and added sugar
                from breakfast are equal too (16%). Lunch is a large source of
                unhealthy nutrients too. There are 29% of sodium, 26% of
                saturated fat and 19% of added sugar have been taken during
                lunch. To conclude, dinner generates the most of unhealthy
                nutrients. People in the USA take the largest proportion of
                added sugar from snacks.
              </article>
            </div>
            <div style="width: 50%">
              <h3 style="font-weight:500;">评价</h3>
              <article>
                The charts compared the average percentages of three types of
                nutrients in typical meals in the USA. It is easy to see that
                both sodium and saturated fat are consumed most in dinner in
